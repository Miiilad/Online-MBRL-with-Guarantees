...
random_seed = 5         # set random seed if required (0 = no random seed)
...
log_r_name = log_dir + '/PPO_' + env_name + "_log_runtime_" + str(run_num) + ".csv"
...
log_f.write('episode,timestep,reward,runtime\n')
log_r = open(log_r_name,"w+")
log_r.write('timestep,runtime\n')
...
while time_step <= max_training_timesteps:
    ...
    for t in range(1, max_ep_len+1):
        ...
        if time_step % update_timestep == 0:
            ...
            ppo_agent.update()
            run_time = datetime.now() - update_time
            
            log_r.write('{},{}\n'.format(time_step, run_time))
            log_r.flush()
